...
function changeBulb(status) {
    if(status === 'Half') {
        circuit.style.backgroundImage = "url(img/finalDimBulb.png)";
    } else if(status === 'Full') {
        circuit.style.backgroundImage = "url(img/finalFullBulb.png)";
    } else {
        circuit.style.backgroundImage = "url(img/finalOffBulb.png)";
    }
}
